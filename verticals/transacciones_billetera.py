...
VERTICAL = {
  ...
  mutate {
    ...
    'fields': [
        ...
        {
            'raw_name': 'entry_time',
            'field_path': 'transaction.entry_time',
            'type': 'keyword',
            'business_label': 'Hora de ingreso (cruda)',
        },
        {
            'raw_name': 'geo_lat',
            'field_path': 'transaction.device.geo_lat',
            'type': 'float',
            'business_label': 'Latitud',
        },
        {
            'raw_name': 'geo_long',
            'field_path': 'transaction.device.geo_long',
            'type': 'float',
            'business_label': 'Longitud',
        },
        {
            'raw_name': 'geo_date',
            'field_path': 'transaction.device.geo_date',
            'type': 'keyword',
            'business_label': 'Fecha de la geolocalización (cruda)',
        },
        {
            'raw_name': 'steps_reached',
            'field_path': 'transaction.funnel.steps_reached',
            'type': 'keyword',
            'business_label': 'Pasos alcanzados',
        },
        {
            'raw_name': 'steps_ok',
            'field_path': 'transaction.funnel.steps_ok',
            'type': 'keyword',
            'business_label': 'Pasos completados',
        },
        {
            'raw_name': 'code',
            'field_path': 'transaction.steps_parsed.data.steps.code',
            'type': 'keyword',
            'business_label': 'Paso (código)',
        },
        {
            'raw_name': 'index',
            'field_path': 'transaction.steps_parsed.data.steps.index',
            'type': 'integer',
            'business_label': 'Paso (orden)',
        },
        {
            'raw_name': 'counter',
            'field_path': 'transaction.steps_parsed.data.steps.counter',
            'type': 'integer',
            'business_label': 'Paso (contador)',
        },
        {
            'raw_name': 'status',
            'field_path': 'transaction.steps_parsed.data.steps.status',
            'type': 'keyword',
            'business_label': 'Paso (estado)',
        },
        {
            'raw_name': 'stepType',
            'field_path': 'transaction.steps_parsed.data.steps.stepType',
            'type': 'keyword',
            'business_label': 'Paso (tipo)',
        },
        {
            'raw_name': 'timedout',
            'field_path': 'transaction.steps_parsed.data.steps.timedout',
            'type': 'keyword',
            'business_label': 'Paso (timeout)',
        },
        {
            'raw_name': 'lateResp',
            'field_path': 'transaction.steps_parsed.data.steps.lateResp',
            'type': 'keyword',
            'business_label': 'Paso (respuesta tardía)',
        }
    ],
    'suggested_questions': [
