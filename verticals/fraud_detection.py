...
VERTICAL = {
  ...
  mutate {
    ...
    'suggested_questions': [
        '¿Cuántas transacciones fraudulentas hubo en total?',
        '¿Cuál es la tasa de fraude por tipo de producto?',
        '¿Qué marcas de tarjeta presentan más transacciones fraudulentas?',
        '¿Cuál es el monto promedio de las transacciones fraudulentas vs las legítimas?',
        '¿Qué tipos de dispositivo están más asociados al fraude?',
        '¿Cuál es la distribución de fraude por código de producto?',
        '¿Qué dominios de email aparecen más en transacciones fraudulentas?',
        '¿Cuántas transacciones fraudulentas hubo por tipo de tarjeta (crédito vs débito)?',
        '¿Cuál es el monto total perdido por fraude?',
        '¿Qué regiones de dirección presentan más transacciones fraudulentas?',
    ],
    'industry_fields': {
        'fraud.amount',
        'fraud.card.brand',
